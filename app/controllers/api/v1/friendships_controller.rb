class Api::V1::FriendshipsController < ApplicationController
  ...
  def pending_requests
    ...
    @friendships.select{|f| f.friend_id.to_s == params[:id]}
  ...
  def completed_requests
    ...
    friends_list = my_friends.map{|num| User.all.find{|user| user.id == num}.username}
  ...
  def accept
    ...
    change_status_of = Friendship.find{|mutual| mutual.user_id == params[:friendId]}
